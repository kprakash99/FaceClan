...
public class RunStart {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String facelocation = "C:\\Users\\aaron\\Documents\\FaceClan\\Face_Clan\\src\\fileIO";
		String photoTaker = facelocation + "\\1home.html";
		
		File htmlFile = new File(photoTaker);
		Desktop.getDesktop().browse(htmlFile.toURI());
		
		File rawFace = new File(facelocation + "\\yourface.png");

		// Checks to see if the file was created, if it wasn't, the thread will sleep for
		// 1 second
		...
		String command2 = "FaceLandmarkImg.exe -f \"" + facelocation + "\\yourface.png\" -out_dir " + facelocation;
		...
		System.out.print("Waiting");
		File csv = new File(facelocation + "\\yourface.csv");
		while (!csv.exists()) {
			TimeUnit.SECONDS.sleep(1);	
			System.out.print(".");
		...
		String happyPage = facelocation + "\\2happy.html";
		String neutralPage = facelocation + "\\3neutral.html";
		String sadPage = facelocation + "\\4sad.html";
		String surprisePage = facelocation + "\\5surprise.html";
		String angerPage = facelocation + "\\6anger.html";
		String disgustPage = facelocation + "\\7disgust.html";
